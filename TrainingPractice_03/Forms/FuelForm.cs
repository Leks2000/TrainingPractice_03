...
namespace TrainingPractice_03.Forms
{
    public partial class FuelForm : Form
    {
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            ...
            if (nameTxt.Text != string.Empty&& decimal.TryParse(priceTxt.Text, out decout))
            {
        ...
        private void LoadComboBox()
        {
            ...
            var command = new SqlCommand(queryString, _dataBase.GetConnection());
            {
                ...
                adapter.Fill(table);
                id_guideTxt.DisplayMember = "sup_id";
                id_guideTxt.ValueMember = "sup_id";
                id_guideTxt.DataSource = table;
            }
        }
